...
const h1 =
  "font-heading text-3xl sm:text-4xl md:text-5xl leading-tight tracking-tight text-white";
...
if (typeof window !== "undefined") {
  try {
    console.assert(
      calc.discountedFirstMonth(179) === 134.25,
      "Starter -25% should be 134.25",
    );
    console.assert(
      calc.discountedFirstMonth(399) === 299.25,
      "Pro -25% should be 299.25",
    );
    console.assert(
  ...
  return (
    <div className="min-h-screen scroll-smooth bg-[#0B1110] text-white [--ring:#6366F1]">
      ...
      >
        {/* soft blobs */}
        <motion.div
          className="absolute left-1/2 top-[-12rem] h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-indigo-500/30 blur-[120px]"
          {...float(0.2)}
        />
        <motion.div
          className="absolute right-[-10rem] bottom-[-8rem] h-[24rem] w-[24rem] rounded-full bg-cyan-500/30 blur-[120px]"
          {...float(0.6)}
        />
        <motion.div
          className="absolute left-[-12rem] bottom-[-14rem] h-[28rem] w-[28rem] rounded-full bg-fuchsia-500/20 blur-[120px]"
          {...float(1.2)}
        />
      ...
      <header className="sticky top-0 z-30 border-b border-white/5 backdrop-blur supports-[backdrop-filter]:bg-[#0B1110]/70">
        <nav className={`${container} flex h-16 items-center justify-between`}>
          <a href="#top" className="group inline-flex items-center gap-2">
            ...
            <span className="font-heading text-white/90 group-hover:text-white">
              Æditus
            </span>
          </a>
      ...
      <section id="top" className="relative">
        ...
        />
        <div
          className={`${container} grid grid-cols-1 items-center gap-10 py-14 md:grid-cols-2 md:py-20`}
        >
          <div>
            <motion.div
              variants={fadeUp}
            ...
            >
              <span className={pill}>
                <Sparkles className="h-4 w-4" /> Visibilité – Authenticité
              </span>
            </motion.div>
            <motion.h1
              variants={fadeUp}
            ...
            >
              <a
                href="#offres"
                className="inline-flex items-center gap-2 rounded-xl bg-indigo-500 px-5 py-3 text-sm font-semibold text-[#0B1110] shadow-lg shadow-indigo-500/20 hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-400/60"
              >
                Démarrer l’essai 7 jours <ChevronRight className="h-4 w-4" />
              </a>
              <a
                href="#offres"
                className="inline-flex items-center gap-2 rounded-xl border border-white/10 px-5 py-3 text-sm font-semibold text-white/80 hover:bg-white/5"
              >
                Voir les offres
              </a>
              <a
            ...
            <motion.ul
              ...
              custom={4}
              viewport={{ once: true }}
              className="mt-5 flex flex-wrap gap-2 text-xs text-white/70"
            >
              <li className="rounded-full border border-white/10 bg-white/5 px-3 py-1">
                Plan mensuel
              </li>
              <li className="rounded-full border border-white/10 bg-white/5 px-3 py-1">
                Publication hebdo multi‑réseaux
              </li>
              <li className="rounded-full border border-white/10 bg-white/5 px-3 py-1">
            ...
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 shadow-2xl">
              ...
              <div className="absolute -right-4 -bottom-4 w-48 rotate-3 rounded-xl border border-indigo-300/30 bg-indigo-400/10 p-3 shadow-xl">
                ...
                <p className="mt-1 text-xs text-indigo-100/80">
                  Style appris et respecté partout.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <section aria-label="badges" className="border-y border-white/5 bg-white/5">
        <div
          className={`${container} flex flex-wrap items-center justify-center gap-6 py-6 text-white/60`}
        >
          <div className="inline-flex items-center gap-2 text-xs">
            <ShieldCheck className="h-4 w-4 text-indigo-300" /> C2PA/filigrane IA (option)
          </div>
          <div className="inline-flex items-center gap-2 text-xs">
            <ArrowRightLeft className="h-4 w-4 text-indigo-300" /> Anti‑répétition & couverture thématique
          </div>
          <div className="inline-flex items-center gap-2 text-xs">
            <MousePointerClick className="h-4 w-4 text-indigo-300" /> Validation ultra‑light
          </div>
        </div>
      </section>
      ...
      <section id="about" className="border-b border-white/5">
        <div className={`${container} py-16 md:py-20`}>
          ...
          <p className={`${sub} mt-2 max-w-3xl`}>
            Un <strong>plan éditorial complet chaque mois</strong> + <strong>publication hebdomadaire</strong> sur vos réseaux, avec votre voix de marque. Validation en 2 clics ou <strong>mode automatique</strong> (réversible). Vidéos & visuels inclus.
          </p>
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-white/80">
                ...
                <li>
                  Garde‑fous de ton : <em>votre voix, votre personnalité</em>
                </li>
      ...
      <section id="offres">
        <div className={`${container} py-16 md:py-20`}>
          ...
          <div className="mt-6 flex items-center justify-center">
            <div
              className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 p-1"
          ...
          >
            <PriceCard
              ...
              price={
                billing === "mensuel"
                  ? euro(prices.essential.monthly)
                  : euro(prices.essential.annual)
              }
            ...
            <PriceCard
              ...
              price={
                billing === "mensuel"
                  ? euro(calc.discountedFirstMonth(prices.starter.monthly))
                  : euro(prices.starter.annual)
              }
              period={billing === "mensuel" ? "/mois" : "/an"}
              strike={billing === "mensuel" ? euro(prices.starter.monthly) : undefined}
              discountNote={
                billing === "mensuel" ? "puis 179€/mois" : "–10% vs mensuel"
              }
              points={[
            ...
            <PriceCard
              ...
              price={
                billing === "mensuel"
                  ? euro(calc.discountedFirstMonth(prices.pro.monthly))
                  : euro(prices.pro.annual)
              }
              period={billing === "mensuel" ? "/mois" : "/an"}
              strike={billing === "mensuel" ? euro(prices.pro.monthly) : undefined}
              discountNote={
                billing === "mensuel" ? "puis 399€/mois" : "–10% vs mensuel"
              }
              points={[
          ...
          <div className="mt-2 text-center text-xs text-white/60">
            Affiliation{"\u00a0"}: 10{"\u00a0"}% sur toutes les offres et sur Fynk.
          </div>
      ...
      <section id="fynk" className="border-t border-white/5 bg-[#0E1514]">
        <div className={`${container} py-16 md:py-20`}>
          ...
          <p className={`${sub} mt-2 max-w-2xl`}>
            Complément d’engagement : réponses/commentaires pertinents proposés, <strong>validation en 1 clic</strong>. Jamais de spam. Règles plateformes respectées.
          </p>
          ...
          <div className="mt-2 text-[10px] text-white/40">
            *Indication issue de comptes pilotes : dépend de la base d’abonnés et de la fréquence de publication.
          </div>
            ...
            <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
              <div>
                ...
                <h3 className="mt-2 font-heading text-xl text-white">
                  Ambassadeurs — 49,90€/mois pendant 3 mois
                </h3>
                <ul className="mt-2 list-disc pl-5 text-sm text-white/80">
                  <li>Actif sur au moins 2 réseaux, sélection sur dossier</li>
                  <li>
                    <strong>4 posts/semaine automatiques</strong> inclus dans votre plan éditorial
                  </li>
                  <li>Avis/témoignage + feedback mensuel</li>
                  <li>
                    Affiliation activée : 10{"\u00a0"}% par parrainage, <strong>15{"\u00a0"}% à partir de 20 clients</strong>
                  </li>
                </ul>
              </div>
              <a
      ...
      <section id="ambassadeurs" className="border-t border-white/5">
        <div className={`${container} py-16 md:py-20`}>
          ...
          <p className={`${sub} mt-2 max-w-3xl`}>
            Devenez l’une des premières marques à installer une présence régulière avec Æditus. En échange de retours concrets, vous profitez d’un tarif préférentiel et d’un accompagnement rapproché — idéal pour poser des bases solides et accélérer la visibilité sans vous trahir.
          </p>
      ...
      <section id="compare" className="border-t border-white/5 bg-[#0E1514]">
        <div className={`${container} py-16 md:py-20`}>
          <motion.h2
            ...
            className={h2}
          >
            Æditus vs concurrents
          </motion.h2>
          <p className={`${sub} mt-2 max-w-3xl`}>
            Pas qu’un scheduler{"\u00a0"}: une chaîne complète de génération + orchestration + publication, avec voix de marque conservée.
          </p>
          ...
          <div className="mt-8 overflow-x-auto rounded-2xl border border-white/10">
            ...
            >
              ...
              <tbody>
                {[
                  [
                    "Génération d’articles SEO + déclinaisons",
                    "Oui",
                    "Non",
                    "Non",
                    "Partiel",
                  ...
                  [
                    "Mémoire tonale (voix/personnalité)",
                    "Oui",
                    "Non",
                    "Non",
                    "Non",
                  ...
                  [
                    "Publication multi‑plateforme auto",
                    "Oui",
                    "Oui",
                    "Oui",
                    "Oui",
      ...
      <section id="faq">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 rounded-2xl border border-white/10 bg-gradient-to-br from-indigo-400/10 to-cyan-400/10 p-6 text-center">
            <h3 className="font-heading text-xl text-white">
              Prêt à installer votre présence régulière{"\u00a0"}?
            </h3>
            <p className="mt-1 text-sm text-white/70">
              Démarrez l’essai 7 jours (sans publication) ou choisissez une offre.
            </p>
            <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
              <a
                href="#offres"
                className="inline-flex items-center gap-2 rounded-xl bg-indigo-500 px-5 py-3 text-sm font-semibold text-[#0B1110] hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-400/60"
              >
        ...
        <div className={`${container} py-16 md:py-20`}>
          ...
          <div className="mt-8 divide-y divide-white/10 rounded-2xl border border-white/10 bg-white/5">
            {[
              {
                q: "Puis‑je valider avant publication\u00a0?",
                a: "Oui. Validation ultra‑light (OK / Éditer / Remplacer). Aucune publication surprise.",
              },
              {
                q: "Quelles plateformes sont supportées\u00a0?",
                a: "Publication sur 20+ réseaux (selon forfait).",
              },
              {
                q: "Et ma voix de marque\u00a0?",
                a: "Votre voix et votre personnalité sont apprises et respectées dans chaque contenu.",
              },
              {
                q: "Fynk, à quoi ça sert\u00a0?",
                a: "Fynk déclenche des interactions utiles (likes/commentaires ciblés) pour augmenter la portée de vos posts et générer des conversations. Résultat\u00a0: plus de vues, plus de réponses et davantage de RDV/Leads.",
              },
            ].map((f, i) => (
      ...
      <footer className="border-t border-white/5">
        ...
        >
          <p className="text-xs text-white/50">
            © {new Date().getFullYear()} Æditus — Visibilité & Authenticité
          </p>
          <div className="flex items-center gap-6 text-xs text-white/50">
            <a href="#offres" className="hover:text-white/80">
              Voir les offres
            </a>
            <a href="#compare" className="hover:text-white/80">
              Comparatif
            </a>
  ...
  return (
    <div
      ...
      className={`relative rounded-2xl border ${
        highlight ? "border-indigo-400/40 bg-indigo-400/10" : "border-white/10 bg-white/5"
      } p-6`}
    >
      {badge && (
      ...
      <ul className="mt-4 space-y-2 text-sm text-white/80">
        {points.map((p, i) => (
          <li key={i} className="inline-flex items-start gap-2">
            <Check className="mt-0.5 h-4 w-4 text-indigo-300" /> {p}
          </li>
        ))}
      </ul>
      <a
...
function AddOnCard({
  ...
  return (
    <div className={`rounded-2xl border ${frame} p-6`}>
      ...
      <span className={`mt-2 inline-flex rounded-full border px-2 py-0.5 text-[10px] ${chip}`}>
        {isPro ? "Pro" : "Basic"}
      </span>
    ...
    <div className="flex flex-wrap items-center gap-4">
      ...
      <svg aria-label="LinkedIn" viewBox="0 0 24 24" className={`${base} ${hover}`}>
        <rect
          ...
          opacity={colored ? 1 : 0.15}
        />
        <rect x="5" y="9" width="3" height="10" fill="#ffffff" />
        <circle cx="6.5" cy="6.5" r="1.5" fill="#ffffff" />
        <path
          d="M11 9h3v1.5c.6-1 1.6-1.7 3-1.7 2.2 0 3 1.3 3 3.5V19h-3v-5c0-1.2-.4-2-1.5-2-1 0-1.5.8-1.5 2V19h-3V9z"
          fill="#ffffff"
        />
      </svg>
      {/* Instagram */}
      <svg aria-label="Instagram" viewBox="0 0 24 24" className={`${base} ${hover}`}>
        ...
        <rect
          ...
          height="18"
          rx="5"
          fill={colored ? "url(#igG)" : "none"}
          stroke={colored ? "none" : "currentColor"}
        />
        <circle
          cx="12"
          cy="12"
      ...
      <svg aria-label="TikTok" viewBox="0 0 24 24" className={`${base} ${hover}`}>
        <rect
          ...
          height="20"
          rx="4"
          fill={colored ? "#000" : "currentColor"}
          opacity={colored ? 1 : 0.15}
        />
        <path
          d="M14 4v6.5c-1-.7-2.1-1.1-3.3-1.1A4.7 4.7 0 0 0 6 14c0 2.6 2.1 4.7 4.7 4.7 2.3 0 4.2-1.7 4.6-3.9V8.2c1 .8 2.2 1.3 3.7 1.4V7.3c-1.5-.1-2.7-.7-3.7-1.7C14.6 4.9 14.2 4.5 14 4z"
          fill={colored ? "#69C9D0" : "currentColor"}
        />
        <path
          d="M14 4c.6.7 1.3 1.3 2.1 1.8 1 .7 2.1 1.1 3.3 1.1V7.3c-1.5-.1-2.7-.7-3.7-1.7-.7-.7-1.2-1.2-1.7-1.6z"
          fill={colored ? "#EE1D52" : "currentColor"}
          opacity={colored ? 1 : 0.8}
        />
      </svg>
      {/* YouTube */}
      ...
      <svg aria-label="Facebook" viewBox="0 0 24 24" className={`${base} ${hover}`}>
        ...
        />
        <path
          d="M13 8h2V5h-2c-2 0-3.5 1.5-3.5 3.5V11H7v3h2.5v5H13v-5h2.2l.3-3H13V9.5c0-.9.4-1.5 1-1.5z"
          fill="#fff"
        />
      </svg>
      {/* X */}
      ...
      <svg aria-label="Pinterest" viewBox="0 0 24 24" className={`${base} ${hover}`}>
        ...
        />
        <path
          d="M12 6.5c-3 0-5 2-5 4.5 0 1.8 1 3.3 2.8 3.6.2 0 .3 0 .3-.2.1-.2.2-.8.2-.8 0-.2-.1-.3-.2-.5-.5-.6-.8-1.5-.8-2.3 0-2.1 1.6-3.5 3.8-3.5 2 0 3.3 1.2 3.3 3 0 2.2-1.1 3.8-2.5 3.8-.8 0-1.4-.6-1.2-1.4l.4-1.7c.1-.5 0-.7-.3-1-.3-.2-.9 0-1.2.5-.3.6-.5 1.4-.5 2 0 1 .3 1.7 1 2 .7.4 1.7.4 2.5 0 1.6-.8 2.7-2.7 2.7-5 0-3-2.2-5.3-5.5-5.3z"
          fill="#fff"
        />
      </svg>
      {/* Threads */}
      <svg aria-label="Threads" viewBox="0 0 24 24" className={`${base} ${hover}`}>
        <rect
          ...
          height="20"
          rx="10"
          fill={colored ? "#000" : "none"}
          stroke={colored ? "#000" : "currentColor"}
        />
        <path
          d="M12 7c3 0 5 1.8 5 5s-2 5-5 5c-2 0-3.5-1.2-3.5-2.6 0-1.3 1-2.2 2.4-2.2 1 0 2 .4 2 .4 0-1.3-.7-2-1.9-2-1 0-1.8.5-2.3 1.2L8 10.7C8.8 9.5 10.2 9 12 9c2.6 0 4.2 1.7 4.2 4.1 0 2.5-1.6 4.1-4 4.1"
          stroke={colored ? "#fff" : "currentColor"}
          fill="none"
        />
      </svg>
