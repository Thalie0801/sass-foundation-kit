...
('fynk', 'Fynk Integration', 'Integration avec la plateforme Fynk pour la gestion de facturation', false, true),
('advanced_analytics', 'Analytics Avancees', 'Acces aux analytics avancees et rapports detailles', false, true),
('team_collaboration', 'Collaboration Equipe', 'Fonctionnalites de collaboration en equipe', false, true),
('api_access', 'Acces API', 'Acces a API pour integrations personnalisees', false, true),
('white_label', 'White Label', 'Personnalisation complete de la marque', false, true);
